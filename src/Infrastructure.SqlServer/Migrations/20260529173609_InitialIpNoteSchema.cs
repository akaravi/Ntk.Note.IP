...
{
    /// <inheritdoc />
    public partial class InitialIpNoteSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Asn = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    Isp = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IpLookupRecords", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotedAtClient = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ClientTimezone = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LocalIpAddress = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
                    ...
                    DeviceInfoJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IpSnapshotJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IpNotes", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IpLookupRecords_Address",
                table: "IpLookupRecords",
                column: "Address");

            migrationBuilder.CreateIndex(
                name: "IX_IpLookupRecords_Created",
                table: "IpLookupRecords",
                column: "Created");

            migrationBuilder.CreateIndex(
                name: "IX_IpNotes_Address",
                table: "IpNotes",
                column: "Address");

            migrationBuilder.CreateIndex(
                name: "IX_IpNotes_Created_Id",
                table: "IpNotes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IpRecords_Address",
                table: "IpRecords",
                column: "Address");

            migrationBuilder.CreateIndex(
                name: "IX_IpRecords_UserId",
                table: "IpRecords",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_IpRecords_UserId_Created",
                table: "IpRecords",
